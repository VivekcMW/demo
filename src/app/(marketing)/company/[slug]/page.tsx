...
export async function generateStaticParams() {
  const slugs = getAllSlugs("company");
      ...
      <section className="py-20 md:py-28 bg-gradient-to-b from-[var(--bg-subtle)] to-white">
        <Container>
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-[var(--text-secondary)] leading-relaxed">
              Sales, support, partnerships — we're here to help.
            </p>
          </div>
        ...
        <Container>
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="lg:pl-12">
              <h2 className="text-2xl font-bold text-foreground mb-6">Office</h2>
    ...
    <>
      ...
      <section className="py-20 md:py-28 bg-gradient-to-b from-[var(--bg-subtle)] to-white">
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6 leading-tight">
              Build India's clinical operating system.
            </h1>
            <p className="text-xl text-[var(--text-secondary)] leading-relaxed mb-8">
              Join a team that ships software doctors actually use — in languages
              they speak, on hardware they have, for the patients they serve.
            </p>
      ...
      <PageCTA
        ...
        subtitle="We're always looking for talented people. Send us your resume."
        primaryCta={{ label: "Send resume", href: "mailto:careers@aarogyaehr.com" }}
      />
    </>
  );
}

function AboutPage({ content }: { content: string }) {
  return (
    <>
      <PageBreadcrumb
        items={[
      ...
      <PageCTA
        ...
        subtitle="A 45-minute demo, configured to your specialty mix."
        primaryCta={{ label: "Book a demo", href: "/book-demo" }}
        secondaryCta={{ label: "Join the team", href: "/company/careers" }}
      />
    </>
  );
}

...
export const GERIATRICS_CONSULT_TEMPLATE: TemplateDefinition = {
  id: "geriatrics-consult",
  name: "Geriatrics Consult",
  type: "SOAP",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "Geriatrics Consult template for Geriatrics",
...
export const GERIATRICS_FOLLOWUP_TEMPLATE: TemplateDefinition = {
  id: "geriatrics-followup",
  name: "Geriatrics Follow-up",
  type: "SOAP",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "Geriatrics Follow-up template for Geriatrics",
    specialties: ["Geriatrics"],
    status: "active",
  },
};
...
export const GERIATRICS_ADMISSION_TEMPLATE: TemplateDefinition = {
  id: "geriatrics-admission",
  name: "Geriatrics Admission",
  type: "Admission",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "Geriatrics Admission template for Geriatrics",
    specialties: ["Geriatrics"],
    status: "active",
  },
};
...
export const GERIATRICS_PROGRESS_TEMPLATE: TemplateDefinition = {
  id: "geriatrics-progress",
  name: "Geriatrics Progress Note",
  type: "Progress",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "Geriatrics Progress Note template for Geriatrics",
    specialties: ["Geriatrics"],
    status: "active",
  },
};

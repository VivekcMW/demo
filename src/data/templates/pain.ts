...
export const PAIN_CONSULT_TEMPLATE: TemplateDefinition = {
  id: "pain-consult",
  name: "Pain & Palliative Care Consult",
  type: "SOAP",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "Pain & Palliative Care Consult template for Pain & Palliative Care",
    specialties: ["Pain Medicine", "Palliative Care"],
    status: "active",
  },
};
...
export const PAIN_FOLLOWUP_TEMPLATE: TemplateDefinition = {
  id: "pain-followup",
  name: "Pain & Palliative Care Follow-up",
  type: "SOAP",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "Pain & Palliative Care Follow-up template for Pain & Palliative Care",
    specialties: ["Pain Medicine", "Palliative Care"],
    status: "active",
  },
};
...
export const PAIN_ADMISSION_TEMPLATE: TemplateDefinition = {
  id: "pain-admission",
  name: "Pain & Palliative Care Admission",
  type: "Admission",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "Pain & Palliative Care Admission template for Pain & Palliative Care",
    specialties: ["Pain Medicine", "Palliative Care"],
    status: "active",
  },
};
...
export const PAIN_PROGRESS_TEMPLATE: TemplateDefinition = {
  id: "pain-progress",
  name: "Pain & Palliative Care Progress Note",
  type: "Progress",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "Pain & Palliative Care Progress Note template for Pain & Palliative Care",
    specialties: ["Pain Medicine", "Palliative Care"],
    status: "active",
  },
};

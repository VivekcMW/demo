...
export const VASCULAR_CONSULT_TEMPLATE: TemplateDefinition = {
  id: "vascular-consult",
  name: "Vascular Surgery Consult",
  type: "SOAP",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "Vascular Surgery Consult template for Vascular Surgery",
...
export const VASCULAR_FOLLOWUP_TEMPLATE: TemplateDefinition = {
  id: "vascular-followup",
  name: "Vascular Surgery Follow-up",
  type: "SOAP",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "Vascular Surgery Follow-up template for Vascular Surgery",
    specialties: ["Vascular Surgery"],
    status: "active",
  },
};
...
export const VASCULAR_ADMISSION_TEMPLATE: TemplateDefinition = {
  id: "vascular-admission",
  name: "Vascular Surgery Admission",
  type: "Admission",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "Vascular Surgery Admission template for Vascular Surgery",
    specialties: ["Vascular Surgery"],
    status: "active",
  },
};
...
export const VASCULAR_PROGRESS_TEMPLATE: TemplateDefinition = {
  id: "vascular-progress",
  name: "Vascular Surgery Progress Note",
  type: "Progress",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "Vascular Surgery Progress Note template for Vascular Surgery",
    specialties: ["Vascular Surgery"],
    status: "active",
  },
};
...
export const VASCULAR_PROCEDURE_TEMPLATE: TemplateDefinition = {
  id: "vascular-procedure",
  name: "Vascular Surgery Procedure",
  type: "Procedure",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "Vascular Surgery Procedure template for Vascular Surgery",
    specialties: ["Vascular Surgery"],
    status: "active",
  },
};

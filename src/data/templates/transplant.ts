...
export const TRANSPLANT_CONSULT_TEMPLATE: TemplateDefinition = {
  id: "transplant-consult",
  name: "Transplant Surgery Consult",
  type: "SOAP",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "Transplant Surgery Consult template for Transplant Surgery",
...
export const TRANSPLANT_FOLLOWUP_TEMPLATE: TemplateDefinition = {
  id: "transplant-followup",
  name: "Transplant Surgery Follow-up",
  type: "SOAP",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "Transplant Surgery Follow-up template for Transplant Surgery",
    specialties: ["Transplant Surgery"],
    status: "active",
  },
};
...
export const TRANSPLANT_ADMISSION_TEMPLATE: TemplateDefinition = {
  id: "transplant-admission",
  name: "Transplant Surgery Admission",
  type: "Admission",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "Transplant Surgery Admission template for Transplant Surgery",
    specialties: ["Transplant Surgery"],
    status: "active",
  },
};
...
export const TRANSPLANT_PROGRESS_TEMPLATE: TemplateDefinition = {
  id: "transplant-progress",
  name: "Transplant Surgery Progress Note",
  type: "Progress",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "Transplant Surgery Progress Note template for Transplant Surgery",
    specialties: ["Transplant Surgery"],
    status: "active",
  },
};

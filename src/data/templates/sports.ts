...
export const SPORTS_CONSULT_TEMPLATE: TemplateDefinition = {
  id: "sports-consult",
  name: "Sports Medicine Consult",
  type: "SOAP",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "Sports Medicine Consult template for Sports Medicine",
...
export const SPORTS_FOLLOWUP_TEMPLATE: TemplateDefinition = {
  id: "sports-followup",
  name: "Sports Medicine Follow-up",
  type: "SOAP",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "Sports Medicine Follow-up template for Sports Medicine",
    specialties: ["Sports Medicine"],
    status: "active",
  },
};
...
export const SPORTS_PROCEDURE_TEMPLATE: TemplateDefinition = {
  id: "sports-procedure",
  name: "Sports Medicine Procedure",
  type: "Procedure",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "Sports Medicine Procedure template for Sports Medicine",
    specialties: ["Sports Medicine"],
    status: "active",
  },
};

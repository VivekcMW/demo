...
export const CTVS_CONSULT_TEMPLATE: TemplateDefinition = {
  id: "ctvs-consult",
  name: "CTVS / Cardiothoracic Surgery Consult",
  type: "SOAP",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "CTVS / Cardiothoracic Surgery Consult template for CTVS / Cardiothoracic Surgery",
    specialties: ["CTVS", "Cardiothoracic Surgery"],
    status: "active",
  },
};
...
export const CTVS_FOLLOWUP_TEMPLATE: TemplateDefinition = {
  id: "ctvs-followup",
  name: "CTVS / Cardiothoracic Surgery Follow-up",
  type: "SOAP",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "CTVS / Cardiothoracic Surgery Follow-up template for CTVS / Cardiothoracic Surgery",
    specialties: ["CTVS", "Cardiothoracic Surgery"],
    status: "active",
  },
};
...
export const CTVS_ADMISSION_TEMPLATE: TemplateDefinition = {
  id: "ctvs-admission",
  name: "CTVS / Cardiothoracic Surgery Admission",
  type: "Admission",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "CTVS / Cardiothoracic Surgery Admission template for CTVS / Cardiothoracic Surgery",
    specialties: ["CTVS", "Cardiothoracic Surgery"],
    status: "active",
  },
};
...
export const CTVS_PROGRESS_TEMPLATE: TemplateDefinition = {
  id: "ctvs-progress",
  name: "CTVS / Cardiothoracic Surgery Progress Note",
  type: "Progress",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "CTVS / Cardiothoracic Surgery Progress Note template for CTVS / Cardiothoracic Surgery",
    specialties: ["CTVS", "Cardiothoracic Surgery"],
    status: "active",
  },
};
...
export const CTVS_PROCEDURE_TEMPLATE: TemplateDefinition = {
  id: "ctvs-procedure",
  name: "CTVS / Cardiothoracic Surgery Procedure",
  type: "Procedure",
  scope: "specialty",
  version: 1,
  sections: [
  ...
  metadata: {
    description: "CTVS / Cardiothoracic Surgery Procedure template for CTVS / Cardiothoracic Surgery",
    specialties: ["CTVS", "Cardiothoracic Surgery"],
    status: "active",
  },
};

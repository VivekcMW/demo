...
import { urologyDashboardData } from "@/data/seeded/urology";
...
const sidebarItems = [
  ...
  { icon: Users, label: "OPD Queue", badge: "36" },
  { icon: Scissors, label: "OT Schedule", badge: "6" },
  { icon: Scan, label: "Cystoscopy", badge: "8" },
  { icon: Droplets, label: "Stone Clinic" },
  { icon: Microscope, label: "Urodynamics" },
...
export function UrologyDashboard() {
  const [activeNav, setActiveNav] = useState("Dashboard");
  const data = urologyDashboardData;
      ...
      <div className="bg-gray-200 px-4 py-2.5 flex items-center gap-3 border-b border-gray-300">
        ...
        <div className="flex-1 flex justify-center">
          <div className="bg-white rounded-md px-4 py-1.5 text-xs text-gray-600 flex items-center gap-2 min-w-70 sm:min-w-85">
            ...
            <span className="truncate">app.aarogyaehr.com/urology/dashboard</span>
          </div>
        </div>
        <div className="w-12" />
      </div>
          ...
          <div className="p-3 border-b border-slate-700">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[9px] text-slate-400">Urology</p>
              </div>
            </div>
          </div>
        ...
        <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1.5 pl-2 border-l border-gray-200">
                ...
                <div className="hidden sm:block">
                  <p className="text-xs font-medium text-gray-900 leading-tight">Dr. Rajesh Jain</p>
                  <p className="text-[9px] text-gray-500 leading-tight">Urologist</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-3 bg-gray-50 space-y-3">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
              ...
              <Stat
                title="Cystoscopies"
                value={data.todayStats.cystoscopies}
            ...
            <div className="grid md:grid-cols-2 gap-3">
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-3">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-sm font-semibold text-gray-900">OT Schedule</h3>
                  <span className="text-[10px] text-sky-600 font-medium">{data.surgeryQueue.length} cases</span>
                </div>
                <div className="space-y-2">
                  {data.surgeryQueue.map((surgery) => (
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-3">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-sm font-semibold text-gray-900">Stone Clinic Registry</h3>
                  <span className="text-[10px] text-amber-600 font-medium">{data.stoneClinic.totalPatients} patients</span>
                </div>
                <div className="space-y-2">
                  <div className="flex items-center justify-between p-2 rounded-lg bg-amber-50">
                    <span className="text-xs font-medium text-gray-700">Renal Stones</span>
                    <span className="text-sm font-bold text-amber-700">{data.stoneClinic.renal}</span>
                  </div>
                  <div className="flex items-center justify-between p-2 rounded-lg bg-orange-50">
                    <span className="text-xs font-medium text-gray-700">Ureteric Stones</span>
                    <span className="text-sm font-bold text-orange-700">{data.stoneClinic.ureteric}</span>
                  </div>
                  <div className="flex items-center justify-between p-2 rounded-lg bg-yellow-50">
                    <span className="text-xs font-medium text-gray-700">Bladder Stones</span>
                    <span className="text-sm font-bold text-yellow-700">{data.stoneClinic.bladder}</span>
                  </div>
                  <div className="flex items-center justify-between p-2 rounded-lg bg-red-50">
                    <span className="text-xs font-medium text-gray-700">Stent In-Situ</span>
                    <span className="text-sm font-bold text-red-700">{data.stoneClinic.stentInSitu}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-3">
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-sm font-semibold text-gray-900">Prostate Registry</h3>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div className="p-3 rounded-lg bg-blue-50">
                  <p className="text-xs font-medium text-gray-700 mb-2">BPH</p>
                  <p className="text-2xl font-bold text-blue-700">{data.prostateRegistry.bph.total}</p>
                  <div className="flex gap-2 mt-2 text-[10px]">
                    <span className="text-gray-500">On Meds: {data.prostateRegistry.bph.onMedication}</span>
                    <span className="text-gray-500">Post-TURP: {data.prostateRegistry.bph.postTURP}</span>
                  </div>
                </div>
                <div className="p-3 rounded-lg bg-red-50">
                  <p className="text-xs font-medium text-gray-700 mb-2">Prostate Cancer</p>
                  <p className="text-2xl font-bold text-red-700">{data.prostateRegistry.cancer.total}</p>
                  <div className="flex gap-2 mt-2 text-[10px]">
                    <span className="text-gray-500">Surveillance: {data.prostateRegistry.cancer.activeSurveillance}</span>
                    <span className="text-gray-500">Surgery: {data.prostateRegistry.cancer.postSurgery}</span>
                  </div>
                </div>
              </div>
            </div>

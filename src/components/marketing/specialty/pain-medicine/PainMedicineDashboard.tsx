...
import { painMedicineDashboardData } from "@/data/seeded/pain-medicine";
...
const sidebarItems = [
  ...
  { icon: Syringe, label: "Procedures", badge: "12" },
  { icon: Target, label: "Registry" },
...
export function PainMedicineDashboard() {
  const [activeNav, setActiveNav] = useState("Dashboard");
  const data = painMedicineDashboardData;
      ...
      <div className="bg-gray-200 px-4 py-2.5 flex items-center gap-3 border-b border-gray-300">
        ...
        <div className="flex-1 flex justify-center">
          <div className="bg-white rounded-md px-4 py-1.5 text-xs text-gray-600 flex items-center gap-2 min-w-70 sm:min-w-85">
            ...
            <span className="truncate">app.aarogyaehr.com/pain-medicine/dashboard</span>
          </div>
        </div>
        <div className="w-12" />
      </div>
          ...
          <div className="p-3 border-b border-slate-700">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[9px] text-slate-400">Pain Medicine</p>
              </div>
            </div>
          </div>
        ...
        <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1.5 pl-2 border-l border-gray-200">
                ...
                <div className="hidden sm:block">
                  <p className="text-xs font-medium text-gray-900 leading-tight">Dr. Vikram Mehta</p>
                  <p className="text-[9px] text-gray-500 leading-tight">Pain Specialist</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-3 bg-gray-50 space-y-3">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
              ...
              <Stat
                title="Blocks"
                value={data.todayStats.blockScheduled}
              ...
              <div className="space-y-2">
                {data.patientQueue.map((patient) => (
                  <div key={patient.id} className="flex items-center justify-between p-2 rounded-lg bg-gray-50">
                    <div className="flex items-center gap-3">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${patient.pain >= 8 ? "bg-red-100 text-red-700" : patient.pain >= 5 ? "bg-amber-100 text-amber-700" : "bg-green-100 text-green-700"}`}>
                        {patient.pain}/10
                      </div>
                      <div>
            ...
            <div className="grid md:grid-cols-2 gap-3">
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="p-2 rounded-lg bg-green-50 text-center">
                    <p className="text-lg font-bold text-green-700">{data.outcomes.painReduction50}%</p>
                    <p className="text-[10px] text-gray-500">Pain Reduction</p>
                  </div>
                  <div className="p-2 rounded-lg bg-blue-50 text-center">
                    <p className="text-lg font-bold text-blue-700">{data.outcomes.functionalImprove}%</p>
                    <p className="text-[10px] text-gray-500">Functional</p>
                  </div>
                  <div className="p-2 rounded-lg bg-purple-50 text-center">
                    <p className="text-lg font-bold text-purple-700">{data.outcomes.opioidReduction}%</p>
                    <p className="text-[10px] text-gray-500">Opioid Reduced</p>
                  </div>
                  <div className="p-2 rounded-lg bg-pink-50 text-center">
                    <p className="text-lg font-bold text-pink-700">{data.outcomes.patientSatisfaction}%</p>
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-3">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-sm font-semibold text-gray-900">Pain Registry</h3>
                </div>
                <div className="space-y-2">
                  <div className="flex items-center justify-between p-2 rounded-lg bg-red-50">
                    <span className="text-xs font-medium text-gray-700">Chronic Pain</span>
                    <span className="text-sm font-bold text-red-700">{data.painRegistry.chronic}</span>
                  </div>
                  <div className="flex items-center justify-between p-2 rounded-lg bg-orange-50">
                    ...
                    <span className="text-sm font-bold text-orange-700">{data.painRegistry.musculoskeletal}</span>
                  </div>
                  <div className="flex items-center justify-between p-2 rounded-lg bg-purple-50">
                    <span className="text-xs font-medium text-gray-700">Neuropathic</span>
                    <span className="text-sm font-bold text-purple-700">{data.painRegistry.neuropathic}</span>
                  </div>
                </div>
              </div>
            </div>
